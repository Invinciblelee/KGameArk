...
class MeshGradient(
    ...
    override val metadata = ShaderMetadata(
        ...
        credit = "https://github.com/JohnnyLeek1/React-Mesh-Gradient",
        license = "MIT License",
...
vec4 main( vec2 fragCoord ) {
    ...
    override fun applyUniforms(runtimeEffect: ShaderEffect, time: Float, width: Float, height: Float) {
        super.applyUniforms(runtimeEffect, time, width, height)

        runtimeEffect.uniform(
