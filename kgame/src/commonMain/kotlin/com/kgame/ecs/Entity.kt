 ...
 * [IntervalSystem], [World] or [com.kgame.ecs.collection.compareEntity].
 */
...
class DefaultEntityProvider(
    ...
    override fun contains(entity: Entity): Boolean =
        activeEntities.getOrNull(entity.id)?.version == entity.version
 ...
 * It also stores the component configuration of each entity as a [com.kgame.ecs.collection.BitArray] to have quick access to
...
class EntityService(
    ...
    initialEntityCapacity: Int,
    @PublishedApi
    internal var entityProvider: EntityProvider = DefaultEntityProvider(
        world,
    ...
    /**
     * Recycles the given [entity] and resets its component mask with an empty [com.kgame.ecs.collection.BitArray].
