...
import com.game.plugins.components.applyLerpFollow
import com.game.plugins.components.applySpringFollow
import com.game.engine.geometry.ViewportTransform
import com.game.engine.geometry.clampPositionInBounds
...
class CameraSystem(
    ...
    override fun onTickEntity(entity: Entity) {
        ...
        if (camera.isTracking) {
            ...
            updateFollow(deltaTime, camera, cameraTarget, cameraTransform, spring, rigidBody)
        }
    ...
    private fun handleTransition(
        ...
        val progress = cameraTransform.applyCameraTransition(transition, deltaTime)
