...
class World internal constructor(
    ...
    /**
     * Returns a new [com.kgame.ecs.collection.EntityBag] instance containing all [entities][Entity] of the world.
     *
    ...
    fun asEntityBag(): EntityBag {
        val result = MutableEntityBag(entitySize)
    ...
    companion object {
         ...
         */
        inline fun <reified T : Component<*>> holder(componentType: ComponentType<T>): ComponentsHolder<T> =
           requireCurrentWorld().holder(componentType)
    }
}
