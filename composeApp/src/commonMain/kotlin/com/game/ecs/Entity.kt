 ...
 * [IntervalSystem], [World] or [com.game.ecs.collection.compareEntity].
 */
 ...
 * It also stores the component configuration of each entity as a [com.game.ecs.collection.BitArray] to have quick access to
...
class EntityService(
    ...
    /**
     * Recycles the given [entity] and resets its component mask with an empty [com.game.ecs.collection.BitArray].
